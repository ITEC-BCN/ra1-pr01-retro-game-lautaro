namespace SpriteKind {
    ...
    export const esfera = SpriteKind.create()
    export const fantasma = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.fantasma, function (sprite, otherSprite) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.forestTiles10, function (sprite, location) {
    ...
    if (escenarioactivo == "ESCENARIO2") {
        tiles.placeOnTile(main, tiles.getTileLocation(0, 12))
        info.changeLifeBy(-1)
    }
})
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.esfera, function (sprite, otherSprite) {
    sprites.destroy(otherSprite, effects.spray, 500)
    esfera = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 6 6 6 6 . . . . . . 
        . . . . 6 6 6 5 5 6 6 6 . . . . 
        . . . 7 7 7 7 6 6 6 6 6 6 . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.esfera)
    tiles.placeOnRandomTile(esfera, sprites.castle.rock1)
    statusbar.value += -10
})
function escenario2 (booleano: boolean) {
    destruirescenario(true)
    game.splash("Tienes que recolectar todas las esferas")
    game.setDialogTextColor(9)
    estadoJuego = "JUEGO"
    escenarioactivo = "ESCENARIO2"
    statusbar = statusbars.create(50, 6, StatusBarKind.Energy)
    statusbar.value = 100
...
function escenario1 (booleano: boolean) {
    destruirescenario(true)
    game.splash("Tienes que llegar hasta el cofre sin que las piedras acaben contigo")
    estadoJuego = "JUEGO"
...
function generarenemigos () {
    ...
    piedra.setPosition(70, randint(70, 90))
}
function moverobstaculos () {
    for (let conversionfantasma of tiles.getTilesByType(sprites.dungeon.collectibleRedCrystal)) {
        fantasma = sprites.create(img`
            ...
            ........................
            `, SpriteKind.fantasma)
        tiles.placeOnTile(fantasma, conversionfantasma)
        fantasma.follow(main, 50)
    }
    pause(10000)
}
